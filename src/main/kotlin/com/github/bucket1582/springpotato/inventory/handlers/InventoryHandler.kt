package com.github.bucket1582.springpotato.inventory.handlers
...
import com.github.bucket1582.springpotato.suggestion.handlers.SuggestionHandler
...
import com.github.bucket1582.springpotato.common.difficulty_indicator.tag.getIndicator
...
object InventoryHandler {
    ...
    fun initSettingWandInventory(player: Player) {
        ...
        WandHandler.helperToolList.forEachIndexed { index, wand: Wand ->
            val item = wand.getWandAsItemStackWithoutEnchant()
            if (WandHandler.isWandPlayerChoice(wand, player)) {
